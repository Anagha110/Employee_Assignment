...
const path = require("path");
 app.use(express.static(path.join(__dirname + "/Employee_Assignment/frontend/build")));
...
app.get('/*', function (req, res) {
  res.sendFile(path.join(__dirname, "/Employee_Assignment/frontend/build/index.html"));
});
